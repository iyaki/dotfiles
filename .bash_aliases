...
alias ga='git add '
type __git_complete &> /dev/null && __git_complete ga _git_add
alias gb='git branch '
type __git_complete &> /dev/null && __git_complete gb _git_branch
alias gc='git commit -m '
alias gca='git commit --amend --no-edit'
alias gco='git checkout '
type __git_complete &> /dev/null && __git_complete gco _git_checkout
alias gd='git diff '
type __git_complete &> /dev/null && __git_complete gd _git_diff
alias gdd='git difftool '
type __git_complete &> /dev/null && __git_complete gdd _git_difftool
...
alias gp='git push '
type __git_complete &> /dev/null && __git_complete gp _git_push
alias gpsu='git push --set-upstream '
type __git_complete &> /dev/null && __git_complete gpsu _git_push
alias gpr='git pr'
complete -F __remote_branch_completion gpr
alias gr='git reset'
type __git_complete &> /dev/null && __git_complete gr _git_reset
alias gs='git status '
type __git_complete &> /dev/null && __git_complete gs _git_status
...
alias viovpn="vi ~/OpenVPN/Alephoo/iyaki_20250523.ovpn"
